...
$data = [
        ...
        ['Иванов', 'Математика', 4],
        ['Иванов', 'Математика', 5],
        ['Петров', 'Математика', 5], // было Петров без кавычек, ошибка синтаксиса, массив не интерпритировался, добавил отлов ошибок и исправил массив чтобы запустить получилось
        ['Сидоров', 'Физика', 4],
        ['Иванов', 'Физика', 4],
        ['Петров', 'ОБЖ', 4],
        ];
